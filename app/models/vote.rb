...
#            Rails.logger.error DateTime.now.to_s + "- " + exp.backtrace.join("\n")
    ...
    def self.process_votes
        Rails.logger.info DateTime.now.to_s + " - " + "Vote Processor Starting"
        ...
        Rails.logger.info DateTime.now.to_s + " - " + "Vote Processor processed #{processed_count} votes and deleted #{deleted_count} votes"
        GC.start
    end
